<?php
	...
	$logout_statement = "DELETE FROM active_users WHERE user = '$datauser'";
	$logout_query = mysqli_query($con,  $logout_statement);
...
<!doctype html>
      ...
      <html>
          ...
          <head>
            ...
            <script src="js/jquery.reveal.js"></script>
          	<meta charset="UTF-8">
            <title>Logout Successful-M2M Dashboard</title>
              ...
              <div id="wrapper">
              	...
              	<div id="content-wrapper">
                	<div id="regsuccessfuldomain">
                    	<p>Successfully logged out. Redirecting you to the homepage. Click <a href="index.html">here</a> if you are not redirected within 5 seconds.</p>
      ...
      <?php
			...
			header ("Refresh: 3; URL=http://m2mdashboard.cfapps.io/index.html");
	  ?>
