<?php
							...
							$sql="INSERT INTO registerdevice (serialnumber, provisiondate, batteryprodate, positioncoordinates, attributelegend, otherattr, domainid1)
							VALUES ('$_POST[serialnumber]', '$_POST[provisiondate]', '$_POST[batteryprovisiondate]', '$_POST[positioncoordinates]', '$_POST[attributelegend]', '$_POST[otherattributes]', '$_POST[domainiddev]')";
              ...
              <div id="wrapper">
              	...
              	<div id="content-wrapper">
                	<div id="regsuccessfuldomain">
                    	<p>Device registration successful!! Your Domain ID is <?php echo "<b>$_POST[domainiddev]</b>" ?>. Please keep your Domain ID in a safe place. </p>
